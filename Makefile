...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Apr 22 07:42:23 2014
...
SOURCES       = glWindow.cpp \
		main.cpp \
		Worker.cpp \
		QCustomGraph/qcustomplot.cpp moc_glWindow.cpp \
		moc_Worker.cpp \
		moc_qcustomplot.cpp
OBJECTS       = glWindow.o \
		main.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/video_cut_detection1.0.0/ && $(COPY_FILE) --parents glWindow.h Worker.h QCustomGraph/qcustomplot.h .tmp/video_cut_detection1.0.0/ && $(COPY_FILE) --parents glWindow.cpp main.cpp Worker.cpp QCustomGraph/qcustomplot.cpp .tmp/video_cut_detection1.0.0/ && (cd `dirname .tmp/video_cut_detection1.0.0` && $(TAR) video_cut_detection1.0.0.tar video_cut_detection1.0.0 && $(COMPRESS) video_cut_detection1.0.0.tar) && $(MOVE) `dirname .tmp/video_cut_detection1.0.0`/video_cut_detection1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/video_cut_detection1.0.0
...
compiler_moc_header_make_all: moc_glWindow.cpp moc_Worker.cpp moc_qcustomplot.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_glWindow.cpp moc_Worker.cpp moc_qcustomplot.cpp
